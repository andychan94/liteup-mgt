 ...
 */
class Version20180411071821 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE agency (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, username_canonical VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, email_canonical VARCHAR(180) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, confirmation_token VARCHAR(180) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', name VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, budget INT NOT NULL, address VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_70C0C6E692FC23A8 (username_canonical), UNIQUE INDEX UNIQ_70C0C6E6A0D96FBF (email_canonical), UNIQUE INDEX UNIQ_70C0C6E6C05FB297 (confirmation_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE house (id INT AUTO_INCREMENT NOT NULL, agency_id INT DEFAULT NULL, status INT NOT NULL, title VARCHAR(255) NOT NULL, price VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, size VARCHAR(255) NOT NULL, commute VARCHAR(255) NOT NULL, essentials VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, balcony_size VARCHAR(255) NOT NULL, aircon INT NOT NULL, parking INT NOT NULL, gas INT NOT NULL, water INT NOT NULL, floor VARCHAR(255) NOT NULL, available INT NOT NULL, view_count INT NOT NULL, like_count INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_67D5399DCDEADB2A (agency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
