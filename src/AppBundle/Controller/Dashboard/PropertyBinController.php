...
class PropertyBinController extends BaseController
{
     ...
     */
    public function deleteAction(House $entity, LoggerInterface $logger, $id)
    {
            ...
            try {
                ...
                foreach ($photos as $key=>$photoPath) {
                    $filesystem = new Filesystem();
                     $filename = $this->get('kernel')->getRootDir().'/../web'.$this->getParameter('uploads_folder') . $photoPath->getPath();
