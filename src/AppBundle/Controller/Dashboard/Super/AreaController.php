...
use AppBundle\Form\AdminAreasFormType;
...
class AreaController extends BaseController
{
     ...
     * @var $objName string
     */
    private $objName = Area::class;
    /**
     * @var $formTypeName string
     */
    private $formTypeName = AdminAreasFormType::class;
    ...
    public function setContainer(ContainerInterface $container = null)
    {
        ...
        $this->entityAltName = "area";
        $this->entityAltNamePlu = "areas";
    }
     ...
     * @return Response
     */
    public function editAction(Area $entity, Request $request, LoggerInterface $logger)
    {
    ...
    /**
     * @Route("/add", name="areas_add_single")
     * @param Request $request
     * @param LoggerInterface $logger
     * @return Response
     */
    ...
    /**
     * @Route("/delete/{id}", name="area_delete_single")
     * @param Area $entity
     * @param LoggerInterface $logger
     * @return RedirectResponse
     */
    public function deleteSingleAction(Area $entity, LoggerInterface $logger)
    {
        /**
         * @var $em EntityManager
         */
    ...
    /**
     * @Route("/delete", name="area_delete_many", methods={"POST"})
     * @param Request $request
     * @param LoggerInterface $logger
     * @return RedirectResponse
     */
    ...
    /**
     * @Route("/empty", name="area_empty", methods={"POST"})
     * @param LoggerInterface $logger
     * @return RedirectResponse
     */
    ...
    /**
     * @Route("/csv", name="area_csv", methods={"POST"})
     * @param Request $request
     * @param LoggerInterface $logger
     * @return RedirectResponse
     */
        ...
        if (isset($_FILES["csv"])) {
            ...
            foreach ($csv as $value) {
                ...
                try {
                    ...
                    $parent = $this->getDoctrine()->getRepository(Lga::class)->find($value[0]);
                    $entity->setLga($parent);
                    $em->persist($entity);
