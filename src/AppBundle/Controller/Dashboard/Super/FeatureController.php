...
use AppBundle\Form\AdminFeaturesFormType;
...
class FeatureController extends BaseController
{
     ...
     * @var $objName string
     */
    private $objName = Feature::class;
    /**
     * @var $formTypeName string
     */
    private $formTypeName = AdminFeaturesFormType::class;
    ...
    public function setContainer(ContainerInterface $container = null)
    {
        ...
        $this->entityName = "Feature";
        $this->entityAltName = "feature";
        $this->entityAltNamePlu = "features";
    }
    ...
    /**
     * @Route("/edit/{id}", name="features_edit")
     * @param Feature $entity
     * @param Request $request
     * @param LoggerInterface $logger
     * @return Response
     */
    public function editAction(Feature $entity, Request $request, LoggerInterface $logger)
    {
    ...
    /**
     * @Route("/add", name="features_add_single")
     * @param Request $request
     * @param LoggerInterface $logger
     * @return Response
     */
    ...
    /**
     * @Route("/delete/{id}", name="feature_delete_single")
     * @param Feature $entity
     * @param LoggerInterface $logger
     * @return RedirectResponse
     */
    public function deleteSingleAction(Feature $entity, LoggerInterface $logger)
    {
        /**
         * @var $em EntityManager
         */
    ...
    /**
     * @Route("/delete", name="feature_delete_many", methods={"POST"})
     * @param Request $request
     * @param LoggerInterface $logger
     * @return RedirectResponse
     */
    ...
    /**
     * @Route("/empty", name="feature_empty", methods={"POST"})
     * @param LoggerInterface $logger
     * @return RedirectResponse
     */
    ...
    /**
     * @Route("/csv", name="feature_csv", methods={"POST"})
     * @param Request $request
     * @param LoggerInterface $logger
     * @return RedirectResponse
     */
